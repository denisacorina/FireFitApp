...
namespace IntentClassification
{
    public partial class MLModel1
    {
        public const string RetrainFilePath = @"C:\Users\DENI\Downloads\nlp_recipe_intents_15000.txt";
        public const string OutputModelPath = @"C:\Users\DENI\source\repos\FireFitBlazor\FireFitBlazor\bin\Debug\net9.0\MlModel1.mlnet";
        ...
        public static void Train(string outputModelPath = OutputModelPath, string inputDataFilePath = RetrainFilePath, char separatorChar = RetrainSeparatorChar, bool hasHeader = RetrainHasHeader, bool allowQuoting = RetrainAllowQuoting)
        {
